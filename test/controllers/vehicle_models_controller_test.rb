...
class VehicleModelsControllerTest < ActionController::TestCase
  ...
  test "should create vehicle_model" do
    assert_difference('VehicleModel.count') do
      post :create, vehicle_model: { name: @vehicle_model.name, vehicle_make_id: @vehicle_model.vehicle_make_id, year: @vehicle_model.year }
    end
  ...
  test "should update vehicle_model" do
    patch :update, id: @vehicle_model, vehicle_model: { name: @vehicle_model.name, vehicle_make_id: @vehicle_model.vehicle_make_id, year: @vehicle_model.year }
    assert_redirected_to vehicle_model_path(assigns(:vehicle_model))
  end
